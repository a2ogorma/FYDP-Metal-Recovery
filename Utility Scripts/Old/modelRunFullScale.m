...
n_units = 4;
initSetBase.solidPCB.m_PCB_total = resultsPreprocessing.productionRate/(8760*CF)*tfinal_base/3600/n_units; %kg/yr/(hr/yr)*hr/cycle = kg/cycle
global rho
...
paramSetBase.Q = 10;% L/s (flowrate)
%cell dimension information
paramSetBase.length = 2.5; % m length of electrodes in flow direction x
...
%Max current density for all rxns
paramSetPrecious.iL_default = 10; %A*m/dm^3
%fsolve options
...
%Practical additions here that dont affect the model
resultsPrecious.practical.pump.flow = resultsPrecious.init.paramSet.Q/1000; %flow rate in system, m^3/s
